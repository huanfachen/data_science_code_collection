# This program performs a stepwise linear regression from data stored in a csv file,
# outputs the subset of selected features.
...
result = stepwise_selection(X, y, threshold_in=0.1, threshold_out=0.3)
